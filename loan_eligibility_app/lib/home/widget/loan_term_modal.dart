...
import 'package:loan_eligibility_app/utils/loan_term.dart';
import 'package:loan_eligibility_app/widget/bottomSheet.dart';

class LoanTermModal extends StatefulWidget {
  const LoanTermModal({super.key});

  static Future<GeneralModel?> show() => CustomBottomSheet.show<GeneralModel>(
        child: const LoanTermModal(),
        padding: EdgeInsets.zero,
      );

  @override
  State<LoanTermModal> createState() => _LoanTermModalState();
}

class _LoanTermModalState extends State<LoanTermModal> {
